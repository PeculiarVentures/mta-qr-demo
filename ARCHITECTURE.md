...
`OriginID` is `SHA-256(origin)[0:8]` stored as a big-endian uint64. It is a routing hint, not a collision-resistant identifier. Cache keys and revocation cache keys MUST use the full origin string.
